...
// ── 컴포넌트 ─────────────────────────────────────────────────────
export default function LdOralHistoryLanding() {
    ...
    >
      <main style={{ position: "relative", zIndex: 1, overflowX: "hidden" }}>
        ...
        <Section id="pain">
          ...
          {/* LinkDrop 강점 — AC 포인트 텍스트 (텍스트 강조 용도) */}
        ...
        {/* ══════════════════════════════════════════════════════
            마무리 CTA — AC 버튼 1개 (DESIGN.md §18 준수)
        ══════════════════════════════════════════════════════ */}
        <section style={{ padding: "96px 24px 120px", textAlign: "center" }}>
          <div style={{ maxWidth: 660, margin: "0 auto" }}>
            ...
            {/* AC 주 CTA 버튼 — 페이지 전체에서 가장 중요한 1개 */}
            <a
