...
export default function Choi3Page() {
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <nav aria-label="Breadcrumb" className="mb-5 flex justify-end">
            <ol className="flex items-center gap-2 text-sm flex-wrap">
              ...
              <li aria-hidden="true"><span className="text-gray-300 text-xs">›</span></li>
              <li><span className="text-violet-600 font-black" aria-current="page">TTS 더빙</span></li>
            </ol>
          </nav>
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <h1 className="text-4xl font-black tracking-tighter text-gray-800">
              최소연 <span className="bg-gradient-to-r from-violet-600 to-purple-800 bg-clip-text text-transparent">× TTS 더빙</span>
            </h1>
          </div>
          <p className="text-gray-500 text-sm">씬별 음성 더빙 생성 및 성우 관리</p>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 -mt-12 relative z-20">
        <section className="rounded-[2rem] p-8 flex flex-col items-center justify-center gap-6 min-h-[320px]" style={{ background: '#e0e5ec', ...neuRaised }}>
          ...
          <div className="text-center">
            <p className="text-2xl font-black text-gray-800 mb-2">TTS 음성 더빙</p>
            <p className="text-gray-500 text-sm">씬별 TTS 음성을 생성하고 성우를 지정합니다.</p>
          </div>
          ...
          <a href="/team/choi-2" className="text-xs text-gray-400 hover:text-violet-600 transition-colors">← 키프레임으로 돌아가기</a>
        </section>
      </main>
