...
export default function Park2Page() {
  const neuRaised = { boxShadow: '8px 8px 16px #b8bcc2, -8px -8px 16px #ffffff' };

  const steps = [
    { label: '대본 생산', icon: '📝', href: '/team/park-1', key: 'park-1' },
    { label: '키프레임',  icon: '🖼️', href: '/team/park-2', key: 'park-2' },
    { label: 'TTS 더빙',  icon: '🎙️', href: '/team/park-3', key: 'park-3' },
    { label: '영상 완성', icon: '🎬', href: '/team/park-4', key: 'park-4' },
  ];
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <nav aria-label="Breadcrumb" className="mb-5 flex justify-end">
            <ol className="flex items-center gap-2 text-sm flex-wrap">
              ...
              <li><a href="/team/park-1" className="text-gray-400 hover:text-violet-600 transition-colors font-medium">팀워크</a></li>
              <li aria-hidden="true"><span className="text-gray-300 text-xs">›</span></li>
              <li><a href="/team/park-1" className="text-gray-400 hover:text-violet-600 transition-colors font-medium">박경태</a></li>
              <li aria-hidden="true"><span className="text-gray-300 text-xs">›</span></li>
              <li><span className="text-violet-600 font-black" aria-current="page">키프레임</span></li>
            </ol>
          </nav>
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <h1 className="text-4xl font-black tracking-tighter text-gray-800">
              박경태 <span className="bg-gradient-to-r from-violet-600 to-purple-800 bg-clip-text text-transparent">× 키프레임</span>
            </h1>
          </div>
          <p className="text-gray-500 text-sm">대본 씬별 키프레임 이미지 생성 및 관리</p>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 -mt-12 relative z-20">
        <section className="rounded-[2rem] p-8 flex flex-col items-center justify-center gap-6 min-h-[320px]" style={{ background: '#e0e5ec', ...neuRaised }}>
          ...
          <div className="text-center">
            <p className="text-2xl font-black text-gray-800 mb-2">키프레임 이미지 제작</p>
            <p className="text-gray-500 text-sm">대본의 각 씬에 맞는 키프레임 이미지를 생성하고 관리합니다.</p>
          </div>
          ...
          <a href="/team/park-1" className="text-xs text-gray-400 hover:text-violet-600 transition-colors">← 대본생산으로 돌아가기</a>
        </section>
      </main>
