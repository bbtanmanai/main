...
export default function Choi2Page() {
  const neuRaised = { boxShadow: '8px 8px 16px #b8bcc2, -8px -8px 16px #ffffff' };

  const steps = [
    { label: '대본 생산', icon: '📝', href: '/team/choi-1', key: 'choi-1' },
    { label: '키프레임',  icon: '🖼️', href: '/team/choi-2', key: 'choi-2' },
    { label: 'TTS 더빙',  icon: '🎙️', href: '/team/choi-3', key: 'choi-3' },
    { label: '영상 완성', icon: '🎬', href: '/team/choi-4', key: 'choi-4' },
  ];
    ...
    <div className="min-h-screen font-sans antialiased pb-20" style={{ background: '#e0e5ec' }}>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <nav aria-label="Breadcrumb" className="mb-5 flex justify-end">
            <ol className="flex items-center gap-2 text-sm flex-wrap">
              ...
              <li><a href="/team/choi-1" className="text-gray-400 hover:text-violet-600 transition-colors font-medium">팀워크</a></li>
              <li aria-hidden="true"><span className="text-gray-300 text-xs">›</span></li>
              <li><a href="/team/choi-1" className="text-gray-400 hover:text-violet-600 transition-colors font-medium">최소연</a></li>
              <li aria-hidden="true"><span className="text-gray-300 text-xs">›</span></li>
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <h1 className="text-4xl font-black tracking-tighter text-gray-800">
              최소연 <span className="bg-gradient-to-r from-violet-600 to-purple-800 bg-clip-text text-transparent">× 키프레임</span>
            </h1>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-6 -mt-12 relative z-20">
        <section className="rounded-[2rem] p-8 flex flex-col items-center justify-center gap-6 min-h-[320px]" style={{ background: '#e0e5ec', ...neuRaised }}>
          ...
          <a href="/team/choi-1" className="text-xs text-gray-400 hover:text-violet-600 transition-colors">← 대본생산으로 돌아가기</a>
        </section>
      </main>
