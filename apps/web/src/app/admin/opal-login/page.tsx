...
export default function AdminOpalLogin() {
  ...
  const API_BASE = `${process.env.NEXT_PUBLIC_API_URL}/opal`;
    ...
    <div className="p-8 font-sans text-slate-800">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8">
          {/* Main Launch Action */}
          <div className="neu-raised rounded-[40px] p-12 text-center relative overflow-hidden">
            <div className="relative z-10">
              ...
              <button
                ...
                className="neu-btn-accent group relative px-12 py-6 text-white rounded-3xl font-black text-2xl flex items-center gap-4 mx-auto"
              >
          ...
          {/* Session Data Board */}
          <div className="neu-raised rounded-[40px] overflow-hidden">
            <div className="p-8 border-b flex justify-between items-center" style={{ borderColor: 'var(--neu-shadow-d)', background: 'var(--neu-bg)' }}>
              ...
              {session.cookies ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {Object.entries(session.cookies).slice(0, 6).map(([key, value]) => (
                    <div key={key} className="neu-flat p-5 flex flex-col gap-1">
                  ...
                  <div className="md:col-span-2 p-4 rounded-2xl flex items-center gap-3 text-blue-700 text-sm font-bold" style={{ background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.2)' }}>
